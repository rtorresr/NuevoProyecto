function controles_SegundaEvaluacion() {
    $('.collapse').show();
    obtenerEvaluacionExp2();

    $('#btn_CancelarSegundaEval').click(function () {
        window.location.href = '/UPromocion/registrarEvaluacion';
    });

    $('#btn_ActivarSegundaEval').click(function () {
        grabarEvaluacion2();
        //  listarRequisitos(); 	
    });
    ...
    $('#btn_registarAvanceSegundaEval').click(function () {
    ...
    $('#btn_RegistrarFinalSegundaEval').click(function () {
        recorrerTablaDetalleEval2(2);
        // listarRequisitos()
    });
}
...
function obtenerEvaluacionExp2() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            console.log('el idEvaluacionExp: ' + result.idEvaluacionExp);
...
function listarRequisitos2() {
    ...
    console.log('el id Cut: ' + idCutExp);
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            dtTable = $('#tablaSegundaEvaluacion').DataTable({
                'destroy': true,
                responsive: true,
                'scrollCollapse': true,
                'pagingType': 'numbers',
                              ...
                              },
                              {
                                 ...
                                 "render": function (data, type, full, meta) {
                                    ...
                                    // console.log('listado - El resultado es: ' + resultado);
                                     ...
                                     //           + ' <select id="cbxCumple_' + full.idRequisitosDocOA + '" class="custom-select" onChange="activarControles2(' + full.idRequisitosDocOA + ')" style="width:100%;"> '
                                     ...
                                     //    return '<td class="center" style=" vertical-align:center; text-align: left"> '
                                     //           + ' <select id="cbxCumple_' + full.idRequisitosDocOA + '" class="custom-select" onChange="activarControles2(' + full.idRequisitosDocOA + ')" style="width:100%;" disabled> '
                                     //           + '  <option value="0">Seleccione</option>'
                                     //           + '  <option value="1">SI</option>'
                                     //           + '  <option value="2">NO</option>'
                                     //           + ' </select>'
...
function recorrerTablaDetalleEval2(opcEvento) {
    ...
    $('#tablaSegundaEvaluacion tbody tr').each(function () {
        ...
        if (idDetalleEvaluacionExp == 0 && opcion == 1) {
            ...
            agregarDetalleEvalAvance2(idEvaluacionExp, idRequisitosDocOA, cumple2, ObservacionesxFormato, RecomendacionesxFormato, idUsuario, count)
        }
        else if (idDetalleEvaluacionExp != 0 && opcion == 1) {
            console.log('listo para actualizar');
            actualizarDetalleEvaluacion2(idDetalleEvaluacionExp, idEvaluacionExp, idRequisitosDocOA, cumple2, ObservacionesxFormato, RecomendacionesxFormato, idUsuario, count);
        }
            ...
            agregarDetalleEvalFinal2(idDetalleEvaluacionExp, idEvaluacionExp, idRequisitosDocOA, cumple2, ObservacionesxFormato, RecomendacionesxFormato, estado, totalFin, idUsuario, count)
        }
...
function agregarDetalleEvalAvance2(idEvaluacionExp, idRequisito, cumple, observacion, recomendacion, idUsuario, count) {
...
function actualizarDetalleEvaluacion2(idDetalleEval, idEvaluacionExp, idRequisito, cumple, observacion, recomendacion, idUsuario, count) {
...
function agregarDetalleEvalFinal2(idDetalleEval, idEvaluacionExp, idRequisito, cumple, observacion, recomendacion, estado, totalFin, idUsuario, count) {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result == 'Se modificó correctamente.') {
                    ...
                    actualizarDetalleEvaluacion2(idDetalleEval, idEvaluacionExp, idRequisito, cumple, observacion, recomendacion, idUsuario, count);
                    control_Botenes2();
                }
                else
                {
...
function control_Botenes2() {
    ...
    if (idEvaluacion != 0) {
        if (resultado == 'Elegible') {
            $('#btn_registarAvanceSegundaEval').hide();
            $('#btn_RegistrarFinalSegundaEval').hide();
            $('#btn_ImprimirSegundoEval').show();
            $('#alertReq').hide();
        }
            ...
            $('#btn_registarAvanceSegundaEval').show();
            $('#btn_RegistrarFinalSegundaEval').show();
            $('#btn_ImprimirSegundoEval').hide();
...
function mostrarActivarEval2() {
    var idEvaluacion = $("#idEvaluacionExp").val();
    console.log('2-el idEvaluacion : ' + idEvaluacion);

    if (idEvaluacion == 0) { 
        $('#btn_ActivarSegundaEval').show();
    }
    else { 
        $('#btn_ActivarSegundaEval').hide();
    }
}
